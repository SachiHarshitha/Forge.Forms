...
namespace Forge.Application.AvaloniaUI.Routing
{
    ...
    public class RouteWrapper<TRoute> : IRouteWrapper<TRoute> where TRoute : Route
    {
        ...
        public TRoute Route => this.InnerWrapper.Route;

        public Task<object> Push(bool cacheCurrentView) => this.InnerWrapper.Push(cacheCurrentView);

        public Task Change() => this.InnerWrapper.Change();
