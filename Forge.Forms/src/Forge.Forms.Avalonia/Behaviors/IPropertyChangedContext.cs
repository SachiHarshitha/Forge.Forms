...
namespace Forge.Forms.AvaloniaUI.Behaviors;
...
{
    public PropertyChangedContext(object model, IFormDefinition formDefinition, object formDefinitionSource,
        object context, IResourceContext resourceContext, string propertyName)
    {
        Model = model;
