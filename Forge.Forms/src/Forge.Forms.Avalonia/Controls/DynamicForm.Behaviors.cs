...
{
    internal static readonly List<object> GlobalBehaviors = new();
    ...
    private void HandleModelChanged()
    {
        ...
        var context = new EventContext(
            ...
            Context,
            ResourceContext);
        foreach (var handler in handlers) ((IModelChangedBehavior)handler).ModelChanged(context);
    }
    ...
    private void HandlePropertyChanged(object sender, PropertyChangedEventArgs args)
    {
        ...
        var context = new PropertyChangedContext(
            ...
            ResourceContext,
            args.PropertyName);
        foreach (var handler in handlers) ((IPropertyChangedBehavior)handler).PropertyChanged(context);
    }
}