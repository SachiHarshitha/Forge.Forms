...
public class FormBindingExtension : MarkupExtension
{
    ...
    private bool _isUpdating;
        ...
        private bool _dataContextSet = false; // Flag to track if DataContext has been set
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            {
                return null;  // Return null if no target object is found.
            }
            ...
            if (pvt.TargetObject is StyledElement styledElement)
            {
                ...
                else
                {
                    ...
                    if ((targetType?.Name == nameof(AvaloniaProperty)) || (targetType?.IsSubclassOf(typeof(AvaloniaProperty)) ?? false))
                    {
        ...
        private void ObserveDataContextChange(StyledElement styledElement)
        {
            ...
            if (_dataContextSubscription != null)
            {
                return;
            }
        ...
        static AvaloniaProperty? GetDependencyProperty(Type type,string propertyName)
        {
            ...
            if (property != null)
            {
                avaloniaProperty = property.GetValue(null) as AvaloniaProperty;
            } 
            return avaloniaProperty;
        }
        
        static PropertyInfo? GetPropInfoProperty(Type type,string propertyName)
        {
